...
GLfloat qaAmbientLight[]    = {0.3, 0.3, 0.3, 0.0};
GLfloat qaDiffuseLight[]    = {0.7, 0.7, 0.7, 0.0};
GLfloat qaSpecularLight[]    = {0.7, 0.7, 0.0, 0.0};
GLfloat emitLight[] = {0.9, 0.9, 0.9, 0.01};
GLfloat Noemit[] = {0.0, 0.0, 0.0, 0.0};
    // Light source position
GLfloat qaLightPosition[]    = {-3,2,0,0};
//GLuint tex[4];
